...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_slr = tk.Label(self, text="Salary:")
        label_slr.place(x=50, y=140)
        ...
        self.entry_slr = ttk.Entry(self)
        self.entry_slr.place(x=200, y=140)
        ...
        self.btn_ok.bind(
            ...
            lambda event: self.view.records(
                self.entry_name.get(), self.entry_email.get(), self.entry_tel.get(), self.entry_slr.get()
            ),
        )
